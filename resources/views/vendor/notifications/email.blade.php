...
$style = [
    ...
    'body_sub' => 'margin-top: 25px; padding-top: 25px; border-top: 1px solid #333333;',

    /* Type ------------------------------ */

    'anchor' => 'color: #3869D4;',
    'header-1' => 'margin-top: 0; color: #CCCCCC; font-size: 19px; font-weight: bold; text-align: left;',
    'paragraph' => 'margin-top: 0; color: #888888; font-size: 16px; line-height: 1.5em;',
    'paragraph-sub' => 'margin-top: 0; color: #888888; font-size: 12px; line-height: 1.5em;',
                            ...
                            <table style="{{ $style['email-footer'] }}" align="center" width="570" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="{{ $fontFamily }} {{ $style['email-footer_cell'] }}">
                                        <p style="{{ $style['paragraph-sub'] }}">
                                            &copy; {{ date('Y') }}
                                            <a style="{{ $style['anchor'] }}" href="{{ url('https://hioctane.org') }}" target="_blank">HiOctane Servers</a>
                                        </p>
                                    </td>
                                </tr>
                            </table>
