...
const checkboxStyle = css<Props>`
    ...
    &:checked {
        ${tw`border-transparent text-primary-500 bg-no-repeat bg-center`};
...
const inputStyle = css<Props>`
    ...
    ${tw`bg-transparent border-primary-500/10 border-primary-500 hover:border-neutral-400 text-neutral-200 shadow-none focus:ring-0`};
